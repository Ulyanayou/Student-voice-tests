...
# Просмотр отзывов 
def test_rating_report_comment(test_true_login):
    ...
    try:
        ...
        WebDriverWait(driver, 10).until(
            EC.presence_of_element_located(('class name', "admin-report__info-btn"))
        )

        info_button = driver.find_element('class name', "admin-report__info-btn")
        info_button.click()

        driver.find_element('xpath', "//h3[text()='Отзыв']")
